...
class TranslationMergerTest {
  ...
  // generateOverride tests

  @Test
  void generateOverrideShouldCommentOutAllTranslationLines() {
  ...
  @Test
  void generateOverrideShouldPreserveBlankLines() {
    List<String> defaults = List.of("Key.One=Value one", "", "Key.Two=Value two");
  ...
  @Test
  void generateOverrideShouldPreserveExistingComments() {
  ...
  @Test
  void generateOverrideShouldNormalizeConsecutiveEmptyLines() {
    List<String> defaults = List.of("Key.One=Value one", "", "", "", "Key.Two=Value two");
  ...
  @Test
  void generateOverrideShouldRemoveTrailingEmptyLines() {
  ...
  @Test
  void generateOverrideShouldHandleEmptyInput() {
  ...
  @Test
  void mergeShouldReturnNoChangesWhenUpToDate() {
    List<String> defaults = List.of("Key.One=Value one", "Key.Two=Value two");
  ...
  @Test
  void mergeShouldAddNewKeyAfterPreviousSibling() {
  ...
  @Test
  void mergeShouldAddNewKeyBeforeNextSiblingWhenNoPreviousFound() {
    List<String> defaults =
        List.of("Key.One=Value one", "Key.Two=Value two", "Key.Three=Value three");
  ...
  @Test
  void mergeShouldAddNewKeyAtEndWhenNoSiblingsFound() {
    List<String> defaults = List.of("Key.One=Value one", "Key.Two=Value two");
  ...
  @Test
  void mergeShouldAddNewKeyWithContext() {
    List<String> defaults =
        List.of(
            "Key.One=Value one",
            "",
  ...
  @Test
  void mergeShouldUpdateOutdatedCommentedKey() {
  ...
  @Test
  void mergeShouldNotUpdateActiveUserTranslation() {
  ...
  @Test
  void mergeShouldPreserveUserCustomKeys() {
    List<String> defaults = List.of("Key.One=Value one");
  ...
  @Test
  void mergeShouldHandleMixedActiveAndCommentedKeys() {
    List<String> defaults =
        List.of("Key.One=Value one", "Key.Two=Value two", "Key.Three=Value three");
    List<String> user =
  ...
  @Test
  void mergeShouldNormalizeEmptyLinesInResult() {
    List<String> defaults = List.of("Key.One=Value one", "Key.Two=Value two");
    List<String> user = List.of("# Key.One=Value one", "", "", "# Key.Two=Value two");
  ...
  @Test
  void mergeShouldInsertBeforeNextKeyContext() {
    List<String> defaults =
        List.of(
            "Key.One=Value one",
            "Key.Two=Value two",
  ...
  @Test
  void mergeShouldHandleMultipleNewKeys() {
    List<String> defaults =
        List.of(
            "Key.One=Value one",
            "Key.Two=Value two",
  ...
  @Test
  void mergeShouldHandleEmptyUserFile() {
    List<String> defaults = List.of("Key.One=Value one", "Key.Two=Value two");
  ...
  @Test
  void mergeShouldHandleEmptyDefaultFile() {
    List<String> defaults = List.of();
  ...
  @Test
  void mergeShouldUpdateMultipleOutdatedCommentedKeys() {
  ...
  @Test
  void mergeShouldHandleKeysWithDotsAndUnderscores() {
  ...
  @Test
  void mergeShouldNotTreatProseCommentsAsKeys() {
    List<String> defaults = List.of("Key.One=Value one");
    ...
    assertEquals(0, output.addedCount());
    assertEquals(0, output.updatedCount());
    assertEquals(List.of("# This is a description comment", "# Key.One=Value one"), output.lines());
  }

  @Test
  void mergeShouldHandleValuesWithSpecialCharacters() {
  ...
  @Test
  void mergeShouldPreserveUserAddedComments() {
    List<String> defaults =
        List.of("Key.One=Value one", "Key.Two=Value two", "Key.Three=Value three");
    List<String> user =
        List.of(
  ...
  @Test
  void mergeShouldMergeDefaultCommentsWithUserStructure() {
    List<String> defaults =
        List.of(
            "Key.One=Value one",
            "",
  ...
  @Test
  void mergeShouldInsertNewKeyWithDefaultContextBeforeUserContext() {
    List<String> defaults =
        List.of(
            "# Section A",
            "Key.A=Value A",
